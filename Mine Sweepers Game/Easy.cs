...
namespace Mine_Sweepers_Game
{
    public partial class Easy : Form
    {
        ...
        private String flag = "🚩";
        private int flagged = 30;
        private int foundmines = 0;
        private int minesno = 30;
        public Easy()
        {
            InitializeComponent();
            this.game = new NewGame(minesno, 15, this);
            int i = 14;
            int j = 14;
        ...
        void checkBoxes(Button b)
        {
            ...
            if (text != mine)
            {
                if (text == "")
                {
                    ...
                    if (j + 1 < 15 && buttons[i, j + 1].Enabled == true)
                    {
                        checkBoxes(buttons[i, j + 1]);
                    }
                    if (i + 1 < 15 && buttons[i + 1, j].Enabled == true)
                    {
                        checkBoxes(buttons[i + 1, j]);
                    }
                }
        ...
        private void howToPlayToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void aboutGameToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
